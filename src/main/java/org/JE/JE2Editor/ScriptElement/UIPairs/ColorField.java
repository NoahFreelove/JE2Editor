...
public class ColorField extends FieldUIPair {
    ...
    public ColorField(Field field, Object ref, Color init, String title) {
        ...
        b[0] = init.b();
        a[0] = init.a();
        titleText = new Label(title, NK_TEXT_ALIGN_LEFT);
    }
    ...
    protected void render(){
        ...
        nk_property_float(UIHandler.nuklearContext, "R", 0, r, 1, 0.05f, 0.01f);
        nk_property_float(UIHandler.nuklearContext, "G", 0, g, 1, 0.05f, 0.01f);
        nk_property_float(UIHandler.nuklearContext, "B", 0, b, 1, 0.05f, 0.01f);
        nk_property_float(UIHandler.nuklearContext, "A", 0, a, 1, 0.05f, 0.01f);
